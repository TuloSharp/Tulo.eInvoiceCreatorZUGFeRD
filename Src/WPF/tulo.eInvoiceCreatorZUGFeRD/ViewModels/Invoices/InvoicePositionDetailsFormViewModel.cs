...
public partial class InvoicePositionDetailsFormViewModel : BaseViewModel
{
    ...
    private bool _isGroupPosition;
    public bool IsGroupPosition
    {
        get => _isGroupPosition;
        set => SetField(ref _isGroupPosition, value);
    }
